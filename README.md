...
The bottom-up simulation means that I simulate the population first, then the households (this is where I am now), from households I can calculate certain economical values as well and I will eventually end up with all the information I need to calculate my society's GDP and other measurements. While doing this, I can simulate shock impulse response functions for example, to see how an artificial war would effect my artificial society, or how bad crops would change birth rate etc. 
